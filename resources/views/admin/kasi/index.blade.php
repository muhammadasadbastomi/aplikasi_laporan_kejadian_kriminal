...
<div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            ...
            <a href="{{Route('admin.kasi.create')}}" class="btn btn-info d-none d-lg-block m-l-15"><i
                    ...
                    <table id="myTable" class="table table-bordered table-striped dataTable no-footer text-center"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{Route('admin.kasi.edit',$d->id)}}" class="btn btn-info m-l-15"><i
                                            class="fa fa-edit"></i>
                                        Edit</a>
                                    <button type="button" data-route="{{Route('admin.kasi.destroy',$d->id)}}"
