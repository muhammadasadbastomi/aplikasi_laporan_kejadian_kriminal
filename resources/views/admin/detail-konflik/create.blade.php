...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form class=" m-t-40" action="{{route('admin.detail_konflik.store')}}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <input type="hidden" value="{{$konflik->id}}" name="konflik_id" class="form-control" id="input3"
                        required>
                ...
                <div class="card-footer text-right">
                    <a href="{{Route('admin.konflik.show',$konflik->id)}}" class="btn btn-danger  m-l-15"><i
