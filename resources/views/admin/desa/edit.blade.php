...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form class="floating-labels m-t-40" action="{{route('admin.desa.update',$desa->id)}}" method="POST"
                enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="card-body">
                    <div class="form-group m-b-40">
                        <input type="text" name="kode_desa" value="{{$desa->kode_desa}}" class="form-control"
                            id="input1" required>
                        <span class="bar"></span>
