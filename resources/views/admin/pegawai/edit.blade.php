...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form class="floating-labels m-t-40" action="{{route('admin.pegawai.update',$pegawai->id)}}" method="POST"
                enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="card-body">
                    <div class="form-group m-b-40">
                        <input type="text" name="nip" value="{{$pegawai->nip}}" class="form-control" id="input1"
                            required>
                        <span class="bar"></span>
                        <label for="input1">NIP</label>
                    </div>
                    <div class="form-group m-b-40">
                        <input type="text" name="nama" value="{{$pegawai->nama}}" class="form-control" id="input1"
                            required>
                        <span class="bar"></span>
                        <label for="input1">Nama Lengkap</label>
                    </div>
                    <div class="form-group m-b-40">
                        <input type="text" name="pangkat" value="{{$pegawai->pangkat}}" class="form-control" id="input3"
                            required>
                        <span class="bar"></span>
                    ...
                    <div class="form-group m-b-40">
                        <select class="form-control p-0" name="jabatan_id" id="input6" required>
                            ...
                            <option value="{{$d->id}}" {{$d->id == $pegawai->jabatan_id ? 'selected' : ''}}>
