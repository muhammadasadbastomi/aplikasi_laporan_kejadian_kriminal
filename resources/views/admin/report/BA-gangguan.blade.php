...
<body>
    ...
    <div class="container">
        ...
        <div class="isi">
            <h2 style="text-align:center; text-decoration:underline;margin:0px;">BERITA ACARA GANGGUAN</h2>
            ...
            <p style="text-align: justify;">Pada hari
                {{carbon\carbon::parse($data->tanggal_gangguan)->translatedFormat('l')}},
                {{carbon\carbon::parse($data->tanggal_gangguan)->translatedFormat('d F Y')}} telah terjadi sebuah
                gangguan dengan keterangan sebagai berikut:</p>
            {{-- <h2 style="text-align: center; text-transform:uppercase;text-decoration:underline;">
                            {{'TES'}}</h2> --}}
            <table>
                <tr>
                    <td width="40%" style="height:50px !important;">Nomor Gangguan</td>
                    <td width="2px">:</td>
                    <td>{{$data->no_gangguan}}</td>
                </tr>
                <tr>
                    <td width="40%" style="height:50px !important;">Deskripsi Gangguan</td>
                    <td width="2px">:</td>
                    <td>{{$data->deskripsi_gangguan}}</td>
                </tr>
                <tr>
                    <td width="40%" style="height:50px !important;">Penanganan</td>
                    <td width="2px">:</td>
                    <td>{{$data->penanganan}}</td>
                </tr>
                <tr>
                    <td width="40%" style="height:50px !important;">Tanggal Gangguan</td>
                    <td width="2px">:</td>
                    <td>{{carbon\carbon::parse($data->tanggal_gangguan)->translatedFormat('d F Y')}}</td>
                </tr>
                <tr>
            ...
            <table>
                <tr>
                    ...
                    <td style="text-align: right; padding-right:30px" width="40%">
                        Banjarbaru,
                        {{carbon\carbon::parse($data->tanggal_gangguan)->translatedFormat('d F Y')}}
                    </td>
                </tr>
            </table>
            <table>
