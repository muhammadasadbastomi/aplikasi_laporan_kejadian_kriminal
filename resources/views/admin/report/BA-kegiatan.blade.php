...
<body>
    ...
    <div class="container">
        ...
        <div class="isi">
            <h2 style="text-align:center; text-decoration:underline;margin:0px;">BERITA ACARA KEGIATAN</h2>
            ...
            <p style="text-align: justify;">Pada hari
                {{carbon\carbon::parse($data->tanggal_kegiatan)->translatedFormat('l')}},
                {{carbon\carbon::parse($data->tanggal_kegiatan)->translatedFormat('d F Y')}} telah diselenggarakan
                kegiatan yang dengan keterangan sebagai berikut:</p>
            {{-- <h2 style="text-align: center; text-transform:uppercase;text-decoration:underline;">
                            {{'TES'}}</h2> --}}
            <table>
                <tr>
                    <td width="40%" style="height:50px !important;">Nomor Kegiatan</td>
                    <td width="2px">:</td>
                    <td>{{$data->no_kegiatan}}</td>
                </tr>
                <tr>
                    <td width="40%" style="height:50px !important;">Nama Kegiatan</td>
                    <td width="2px">:</td>
                    <td>{{$data->nama_kegiatan}}</td>
                </tr>
                <tr>
                    <td width="40%" style="height:50px !important;">Tanggal Kegiatan</td>
                    <td width="2px">:</td>
