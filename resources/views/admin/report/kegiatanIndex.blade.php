...
<div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            ...
            <a target="_blank" href="{{Route('admin.report.kegiatanAll')}}" class="btn btn-info  m-l-15"><i
                    class="fa fa-print"></i>
                Cetak Semua</a>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form target="_blank" class="floating-labels m-t-40"
                            action="{{route('admin.report.kegiatanYear')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                    ...
                    <div class="col-md-6">
                        <form target="_blank" class="floating-labels m-t-40"
                            action="{{route('admin.report.kegiatanMonth')}}" method="POST"
