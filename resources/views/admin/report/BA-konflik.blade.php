...
<body>
    ...
    <div class="container">
        ...
        <div class="isi">
            <h2 style="text-align:center; text-decoration:underline;margin:0px;">BERITA ACARA KONFLIK</h2>
            ...
            <p style="text-align: justify;">Pada hari
                {{carbon\carbon::parse($data->tanggal_konflik)->translatedFormat('l')}},
                {{carbon\carbon::parse($data->tanggal_konflik)->translatedFormat('d F Y')}} telah terjadi sebuah
                konflik dengan keterangan sebagai berikut:</p>
            {{-- <h2 style="text-align: center; text-transform:uppercase;text-decoration:underline;">
                            {{'TES'}}</h2> --}}
            <table>
                <tr>
                    <td width="40%" style="height:50px !important;">Nomor Konflik</td>
                    <td width="2px">:</td>
                    <td>{{$data->no_konflik}}</td>
                </tr>
                <tr>
                    <td width="40%" style="height:50px !important;">Deskripsi Konflik</td>
                    <td width="2px">:</td>
                    <td>{{$data->deskripsi_konflik}}</td>
                </tr>
                <tr>
                    <td width="40%" style="height:50px !important;">Tanggal Konflik</td>
                    <td width="2px">:</td>
                    <td>{{carbon\carbon::parse($data->tanggal_konflik)->translatedFormat('d F Y')}}</td>
                </tr>
                <tr>
            ...
            <table>
                <tr>
                    ...
                    <td style="text-align: right; padding-right:30px" width="40%">
                        Banjarbaru,
                        {{carbon\carbon::parse($data->tanggal_konflik)->translatedFormat('d F Y')}}
                    </td>
                </tr>
            </table>
            <table>
