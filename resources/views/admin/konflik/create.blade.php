...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form class="floating-labels m-t-40" action="{{route('admin.konflik.store')}}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="form-group m-b-40">
                        <input type="text" name="no_konflik" class="form-control" id="input3" required>
                        <span class="bar"></span>
                        <label for="input3">Nomor Konflik</label>
                    </div>
                    <div class="form-group m-b-40">
                    ...
                    <div class="form-group m-b-40">
                        <input type="date" name="tanggal_konflik" class="form-control" id="input1" required>
                        <span class="bar"></span>
